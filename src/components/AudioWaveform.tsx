...
const AudioWaveform = forwardRef<HTMLDivElement, AudioWaveformProps>(
  ({ isActive, className, barCount = 5 }, ref) => {
    ...
    return (
      <div ref={ref} className={cn('flex items-center justify-center gap-0.5 h-6', className)}>
